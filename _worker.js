...
const proxyIPs= ['5.161.131.62,5.161.228.130,34.123.83.237,35.202.158.120,99.83.209.185'];
...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `Ali😉 - Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `Ali😉 - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `Ali😉 - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `Ali😉 - Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'Ali😉 Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = 'Ali😉 Frag - Best Ping 💥';
    ...
    bestFragment.remarks = 'Ali😉 Frag - Best Fragment 😎';
...
const getWarpConfigs = async (env, client) => {
    ...
    xrayWarpBestPing.remarks = 'Ali😉 - Warp Best Ping 🚀'
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag.includes('warp-out')) {
            ...
            xrayWoWConfig.remarks = `Ali😉 - WoW ${index/2 + 1} 🌍`;
