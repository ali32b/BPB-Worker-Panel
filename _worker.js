...
async function buildXrayWorkerLessConfig(remoteDNS, localDNS, lengthMin,  lengthMax,  intervalMin,  intervalMax, fragmentPackets, blockAds, bypassIran, blockPorn, bypassLAN, bypassChina, blockUDP443) {
    ...
    fragConfig.remarks  = 'Ali😉 F - WorkerLess ⭐'
...
async function getXrayFragmentConfigs(env, hostName) {
    ...
    bestPing.remarks = 'Ali😉 F - Best Ping 💥';
...
async function getXrayWarpConfigs (env, client) {
    ...
    xrayWarpBestPing.remarks = client === 'nikang' ? 'Ali😉 Warp Pro Best Ping 🚀' : 'Ali😉 Warp Best Ping 🚀';
    ...
    xrayWarpOutbounds.forEach((outbound, index) => {
        xrayWarpConfigs.push({
            ...xrayWarpConfig,
            remarks: client === 'nikang' ? `Ali😉 Warp Pro ${index + 1} 🇮🇷` : `Ali😉 Warp ${index + 1} 🇮🇷`,
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag === 'chain') {
            ...
            xrayWoWConfig.remarks = client === 'nikang' ? `Ali😉 WoW Pro ${proxyIndex} 🌍` : `Ali😉 WoW ${proxyIndex} 🌍`;
    ...
    xrayWoWBestPing.remarks = client === 'nikang' ? 'Ali😉 WoW Pro Best Ping 🚀' : 'Ali😉 WoW Best Ping 🚀';
...
async function getClashConfig (env, hostName, isWarp) {
    ...
    if (isWarp) {
        config['proxy-groups'][0].proxies = ['Ali😉 Warp Best Ping 🚀', 'Ali😉 WoW Best Ping 🚀'];
        config['proxy-groups'][1].name = 'Ali😉 Warp Best Ping 🚀';
        config['proxy-groups'][1].interval = +bestWarpInterval;
        config['proxy-groups'].splice(2, 0, structuredClone(config['proxy-groups'][1]));
        config['proxy-groups'][2].name = 'Ali😉 WoW Best Ping 🚀';
        ...
        config['proxy-groups'][0].proxies = ['Ali😉 Best Ping 💥'];
        config['proxy-groups'][1].name = 'Ali😉 Best Ping 💥';
